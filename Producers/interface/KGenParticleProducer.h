...
{
public:
	KBasicGenParticleProducer(const edm::ParameterSet& cfg, TTree* _event_tree, TTree* _lumi_tree, const std::string& producerName, edm::ConsumesCollector && consumescollector) :
		KBaseMultiLVProducer<edm::View<reco::Candidate>, TProduct>(cfg, _event_tree, _lumi_tree, producerName, std::forward<edm::ConsumesCollector>(consumescollector)) {}
...
{
public:
	KGenParticleProducer(const edm::ParameterSet& cfg, TTree* _event_tree, TTree* _lumi_tree, edm::ConsumesCollector && consumescollector) :
		KBasicGenParticleProducer<KGenParticles>(cfg, _event_tree, _lumi_tree, getLabel(), std::forward<edm::ConsumesCollector>(consumescollector)) {}
