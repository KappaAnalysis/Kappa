...
REGISTER_NAME_OF_TYPE(KDataPFTaggedJet);
REGISTER_NAME_OF_TYPE(KDataPFTaggedJets);
...
REGISTER_NAME_OF_TYPE(KFilterSummary);
REGISTER_NAME_OF_TYPE(KFilterMetadata);
