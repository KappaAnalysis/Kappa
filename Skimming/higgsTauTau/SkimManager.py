...
if __name__ == "__main__":
	...
	parser.add_argument("--summary", action='store_true', default=True, dest="summary", help="Prints summary and writes skim_summary.json in workdir with quick status overview of crab tasks.")
