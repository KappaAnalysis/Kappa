...
process.kappaTuple.outputFile = 'kappaTuple_pfCandidates.root'                                       ## name of output file
process.kappaTuple.active     = cms.vstring('PFCandidates')                                          ## produce KappaPFCandidates
...
process.edmOut = cms.OutputModule("PoolOutputModule",
                               fileName = cms.untracked.string('patTuple_pfCandidates.root'),        ## name of output file 
