...
def getBaseConfig(globaltag, testfile="", maxevents=0, datatype='data'):
    ...
    # soft electron b-tag
    process.ak5PFsoftPFElectronsTagInfos = process.softPFElectronsTagInfos.clone()
    process.ak5PFsoftPFElectronsTagInfos.jets = "ak5PFJets"
    process.ak5PFSoftElectronBJetTags = process.softElectronBJetTags.clone()
    process.ak5PFSoftElectronBJetTags.tagInfos = cms.VInputTag(cms.InputTag("ak5PFsoftPFElectronsTagInfos"))
    ...
    process.ak5PFJetBtaggingEle = cms.Sequence(process.softElectronBJetTags * process.ak5PFsoftPFElectronsTagInfos * process.ak5PFSoftElectronBJetTags)
    ...
    # soft electron b-tag
    process.ak5PFCHSsoftPFElectronsTagInfos = process.softPFElectronsTagInfos.clone()
    process.ak5PFCHSsoftPFElectronsTagInfos.jets = "ak5PFJetsCHS"
    process.ak5PFCHSSoftElectronBJetTags = process.softElectronBJetTags.clone()
    process.ak5PFCHSSoftElectronBJetTags.tagInfos = cms.VInputTag(cms.InputTag("ak5PFCHSsoftPFElectronsTagInfos"))
    ...
    process.ak5PFCHSJetBtaggingEle = cms.Sequence(process.softElectronBJetTags * process.ak5PFCHSsoftPFElectronsTagInfos * process.ak5PFCHSSoftElectronBJetTags)
    ...
    # soft electron b-tag
    process.ak7PFsoftPFElectronsTagInfos = process.softPFElectronsTagInfos.clone()
    process.ak7PFsoftPFElectronsTagInfos.jets = "ak7PFJets"
    process.ak7PFSoftElectronBJetTags = process.softElectronBJetTags.clone()
    process.ak7PFSoftElectronBJetTags.tagInfos = cms.VInputTag(cms.InputTag("ak7PFsoftPFElectronsTagInfos"))
    ...
    process.ak7PFJetBtaggingEle = cms.Sequence(process.softElectronBJetTags * process.ak7PFsoftPFElectronsTagInfos * process.ak7PFSoftElectronBJetTags)
    ...
    # soft electron b-tag
    process.ak7PFCHSsoftPFElectronsTagInfos = process.softPFElectronsTagInfos.clone()
    process.ak7PFCHSsoftPFElectronsTagInfos.jets = "ak7PFJetsCHS"
    process.ak7PFCHSSoftElectronBJetTags = process.softElectronBJetTags.clone()
    process.ak7PFCHSSoftElectronBJetTags.tagInfos = cms.VInputTag(cms.InputTag("ak7PFCHSsoftPFElectronsTagInfos"))
    ...
    process.ak7PFCHSJetBtaggingEle = cms.Sequence(process.softElectronBJetTags * process.ak7PFCHSsoftPFElectronsTagInfos * process.ak7PFCHSSoftElectronBJetTags)
