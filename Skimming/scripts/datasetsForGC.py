...
def main():
	...
	parser.add_option("-o", "--output-dir", help="Output directory where to put the configurations", default="$CMSSW_BASE/src/Kappa/Skimming/higgsTauTau/samples/")
