...
if __name__ == '__main__':
	...
	if('@' in '@NICK@'):
		...
		# defaults
		default_nevents = 100
		default_testfile = '/storage/a/berger/kappatest/input/VBF_HToTauTau_M-125_13TeV_PHYS14.root'
		default_globaltag = 'PHYS14_25_V1::All'
		default_outputfilename = 'kappatuple.root'
		default_nickname = 'SM_VBFHToTauTau_M_125_powheg_pythia_13TeV'
